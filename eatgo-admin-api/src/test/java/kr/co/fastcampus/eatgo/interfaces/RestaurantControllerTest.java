...
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*; //patch 맞겠지
...
public class RestaurantControllerTest {
    ...
    public void createWithValidData() throws Exception {
        ...
        mvc.perform(post("/restaurants")
                ...
                .andExpect(header().string("location","/restaurants/1234")) //1234아닌 것 같은데 자꾸 오류남
    ...
    @Test //이름쪽이 의심간다면 이렇게 유효성 검사를 추가해주면 된다.
